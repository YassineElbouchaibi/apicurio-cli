...
"#;
        ...
        // Create lockfile
        let config_hash = crate::lockfile::LockFile::compute_config_hash(config_content, &deps);
        let config_modified =
            crate::lockfile::LockFile::get_config_modification_time(&config_path).ok();

        let locked_dep = crate::lockfile::LockedDependency {
            name: "service1".to_string(),
            registry: "default".to_string(),
        ...
        let lockfile = crate::lockfile::LockFile::with_config_modified(
...
"#;
        ...
        let modified_deps = vec![crate::config::DependencyConfig {
            name: "service1".to_string(),
            group_id: "com.example".to_string(),
            artifact_id: "service1".to_string(),
        ...
        let new_config_hash =
            crate::lockfile::LockFile::compute_config_hash(modified_config, &modified_deps);
        assert_ne!(
...
"#;
        ...
        let hash1 = crate::lockfile::LockFile::compute_config_hash(config1, &deps);
        let hash2 = crate::lockfile::LockFile::compute_config_hash(config2, &deps);
